...
export interface BatchAttestationLogicContract
  ...
  'new'(meta?: Truffle.TransactionDetails): Promise<BatchAttestationLogicInstance>
}
...
export interface PauserRoleContract extends Truffle.Contract<PauserRoleInstance> {
...
export interface AirdropProxyInstance extends Truffle.ContractInstance {
  ...
  pause(txDetails?: Truffle.TransactionDetails): Promise<Truffle.TransactionResponse>
...
export interface AttestationLogicInstance extends Truffle.ContractInstance {
  ...
  initializing(txDetails?: Truffle.TransactionDetails): Promise<boolean>
  tokenEscrowMarketplace(txDetails?: Truffle.TransactionDetails): Promise<string>
  initializer(txDetails?: Truffle.TransactionDetails): Promise<string>
}

export interface BatchAttestationLogicInstance extends Truffle.ContractInstance {
  batchAttest(
    _dataHash: string | BigNumber,
    txDetails?: Truffle.TransactionDetails
  ): Promise<Truffle.TransactionResponse>
...
export interface PollInstance extends Truffle.ContractInstance {
  ...
  pollDataMultihash(txDetails?: Truffle.TransactionDetails): Promise<(string)[]>
...
export interface TokenEscrowMarketplaceInstance extends Truffle.ContractInstance {
  tokenEscrow(
    arg0: string | BigNumber,
    txDetails?: Truffle.TransactionDetails
  ): Promise<BigNumber>
